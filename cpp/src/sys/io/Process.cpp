...
HX_DEFINE_STACK_FRAME(_hx_pos_7c70be85a4c009b3_94_new,"sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","sys/io/Process.hx",94,0x38a91ed6)
HX_LOCAL_STACK_FRAME(_hx_pos_7c70be85a4c009b3_108_exitCode,"sys.io.Process","exitCode",0x41e72111,"sys.io.Process.exitCode","sys/io/Process.hx",108,0x38a91ed6)
HX_LOCAL_STACK_FRAME(_hx_pos_7c70be85a4c009b3_112_close,"sys.io.Process","close",0x0a954e52,"sys.io.Process.close","sys/io/Process.hx",112,0x38a91ed6)
namespace sys{
namespace io{

void Process_obj::__construct(::String cmd,::Array< ::String > args, ::Dynamic detached){
            	HX_GC_STACKFRAME(&_hx_pos_7c70be85a4c009b3_94_new)
...
bool Process_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Process_obj::exitCode(::hx::Null< bool >  __o_block){
            	...
            	HX_STACKFRAME(&_hx_pos_7c70be85a4c009b3_108_exitCode)
...
void Process_obj::close(){
            	HX_STACKFRAME(&_hx_pos_7c70be85a4c009b3_112_close)
